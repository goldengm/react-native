                ...
                <ImageBackground source={require("../assets/imgs/empty.png")} style={{width: '100%', height: '100%'}}>
                    ...
                    <View style={{flex: 2, flexDirection: 'row'}}>
                        ...
                        <View style={{flex: 4, justifyContent: 'center'}}>
                            <Text style={{margin: 'auto', color: 'white', fontSize:18, fontWeight:"bold",marginTop:-50}}>RITUALES</Text>
                        </View>
                    </View>
                    {/* Content */}
                    <View style={{flex: 3, flexDirection: 'row'}}>                        
                        <View style={{flex: 1, flexDirection: 'row'}}>
                            <Image source={require("../assets/imgs/A-5.png")} style={{width: '100%', height: '100%'}}></Image>
                        </View>
                    </View> 
